...
print("每件衣服的销售额占比:羽绒服:{:.2f}%".format((10+69+140+10+10)*253.6/196464.6*100),
      "牛仔裤:{:.2f}%".format((60+72+35+90+60+60+140)*86.3/196464.6*100),
      "风衣:{:.2f}%".format((43+25+43+60+43+78)*96.8/196464.6*100),
      "皮草:{:.2f}%".format((63+24+63+57)*135.9/196464.6*100),
      "T恤:{:.2f}%".format((63+45+129+63+58+48+63)*65.8/196464.6*100),
      "衬衫:{:.2f}%".format(120*49.3/196464.6*100),)
